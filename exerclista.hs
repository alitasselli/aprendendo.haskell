...
--2.
--Crie uma funcao que receba dois inteiros como argumento e 
--gere todas as possiveis combinacoes ate k(2 parametro)numeros
--distintos escolhidos de uma lista contendo de 0 ate N-1(1 par)num
...
--EXTRA Defina uma função que receba três números 
--e retorne a dupla formada pelo menor e maior elemento
